...
class EvaluacionAdd(TemplateView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            obj.Evidencia_grupoColegiados = request.FILES.get('Evidencia_grupoColegiados',False)
            obj.Estudiantes = form.cleaned_data['Estudiantes']
            obj.Descripcion_estudiantes = form.cleaned_data['Descripcion_estudiantes']
            obj.Evidencia_estudiante = request.FILES.get('Evidencia_estudiante', False)
            ...
            obj.Evidencia_instancias = request.FILES.get('Evidencia_instancias', False)
            obj.Hay_difusion = form.cleaned_data['Hay_difusion']
            obj.Tipo_difusion = form.cleaned_data['Tipo_difusion']
            obj.Resultados_periodos = request.FILES.get('Resultados_periodos', False)
